      ...
      if (verbCardsData && verbCardsData.length > 0) {
        cardsToInsert = verbCardsData.map(vc => ({
          ...
          layout: {
            ...
            answer: "<strong>Past:</strong> {{fields.past_tense.arabic}} ({{fields.past_tense.transliteration}})<br><strong>Present:</strong> {{fields.present_tense.arabic}} ({{fields.present_tense.transliteration}})",
          },
