    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white dark:bg-dark-200 rounded-lg shadow-xl max-w-xs w-full p-6 relative max-h-[90vh]">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 overflow-y-auto pr-2">
          ...
          {/* Error message - moved inside form */}
          {error && (
            <div className="mt-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-400 p-3 rounded-md">
              {error}
            </div>
          )}
